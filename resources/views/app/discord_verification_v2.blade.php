								...
								<div class="border p-4 rounded">
									...
									<div class="text-center mb-4">
                                        ...
                                        <p class="text-white text-start">
                                            Please log in with your discord account to verify your account. If you have an active session in the browser, operations occur automatically. Please accept the permissions requested by our bot. You can review our <a href="">Privacy Policy</a> for the data we use and store.
                                        </p>
									</div>
									...
									<div class="form-body mb-4">
										<form class="row g-3" action="javascript:;">
											...
											<div class="col-12">
												<div class="d-grid">
													<a href="https://discord.com/api/oauth2/authorize?client_id=1172940675940110336&redirect_uri=http%3A%2F%2F127.0.0.1%3A8000%2Fapp%2Fverification%2Fv2%2Fdiscord%2Fconfirmation&response_type=code&scope=identify" class="btn btn-primary mb-4"><i class="bx bxs-lock-open"></i>Log In With Discord</a>
                                                    <p>
