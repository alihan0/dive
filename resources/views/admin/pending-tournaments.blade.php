...
@section('title', 'Pending Tournaments')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body border-bottom align-items-center self-center d-flex justify-content-between">
                    <h4 class="card-title ">Pending Tournaments</h4>
                    <div class="btn-group" role="group" aria-label="Basic outlined example">
                        ...
                        <a href="/admin/tournament/pending" class="btn btn-outline-danger active">Pending</a>
